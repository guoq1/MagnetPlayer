package com.guoqi.magnetplayer.core
...
import com.guoqi.magnetplayer.core.extensions.*
import com.guoqi.magnetplayer.core.models.TorrentSessionBuffer
...
class TorrentSession(
    ...
    private fun setInitialTorrentState(torrentHandle: TorrentHandle) {
        ...
        torrentSessionBuffer = TorrentSessionBuffer(torrentSessionBuffer.bufferSize, torrentHandle.getStartPieceIndex(largestFileIndex), torrentHandle.getEndPieceIndex(largestFileIndex))
